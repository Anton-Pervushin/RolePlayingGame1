public class BattleScene {
    public void fight(FantasyMap hero, FantasyMap monster, Realm.FightCallback fightCallback){
        Runnable runnable = () -> {
            int turn = 1;
    ...
    private Boolean makeHit(FantasyMap defender, FantasyMap attacker, Realm.FightCallback fightCallback) {
